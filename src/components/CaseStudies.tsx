        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 lg:gap-7 px-5 sm:px-8 lg:px-12">
          ...
          <div>
            <div className="relative aspect-[329/246] rounded-2xl overflow-hidden bg-[#1a1d2e] group cursor-pointer">
              ...
              />
              <div className="absolute bottom-4 left-4 flex items-center h-9 w-9 group-hover:w-[148px] rounded-full bg-white overflow-hidden transition-all duration-300 ease-in-out">
                <span className="flex items-center justify-center h-9 w-9 flex-shrink-0">
                  <LinkIcon className="text-gray-900 -rotate-45 group-hover:rotate-0 transition-transform duration-300 ease-in-out" />
                </span>
          ...
          <div>
            <div className="relative aspect-square rounded-2xl overflow-hidden bg-[#6b6b6b] group cursor-pointer">
              <video
                ...
                className="w-full h-full object-cover"
              />
              <div className="absolute bottom-4 left-4 flex items-center h-9 w-9 group-hover:w-[168px] rounded-full bg-gray-900 overflow-hidden transition-all duration-300 ease-in-out">
                <span className="flex items-center justify-center h-9 w-9 flex-shrink-0">
                  <ArrowRight
                    size={14}
